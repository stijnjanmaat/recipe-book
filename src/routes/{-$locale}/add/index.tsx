...
function AddRecipeFromUrlTab({
  ...
  setExtraOptions: React.Dispatch<
    React.SetStateAction<{ outputLanguage: string; measurementSystem: string }>
  >;
  onCancel: () => void;
}) {
  const { t } = useTranslation();
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
        <div className="space-y-2">
          <Label htmlFor="image-outputLanguage">
            {t("addRecipe.outputLanguage")}
          </Label>
          <Select
            value={extraOptions.outputLanguage}
        ...
        <div className="space-y-2">
          <Label htmlFor="image-measurementSystem">
            {t("addRecipe.measurementSystem")}
          </Label>
          <Select
            value={extraOptions.measurementSystem}
          ...
          {preview ? (
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg font-medium">
                {isDragActive
                  ? t("addRecipe.dragActive")
                  : t("addRecipe.dragDrop")}
              </p>
