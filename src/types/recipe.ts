...
export const InstructionSchema = z.object({
  ...
  imageUrl: z.string().refine((val) => !val || URL.canParse(val), {
...
export const RecipeSchema = z.object({
  ...
  sourceImageUrl: z.string().refine((val) => !val || URL.canParse(val), {
    message: 'Invalid URL format',
  }).optional(),
  imageBlobUrl: z.string().refine((val) => !val || URL.canParse(val), {
    message: 'Invalid URL format',
  }).optional(),
